...
<input type="hidden" value="<?php echo $usuario_id; ?>" name="usuario_id">
	...
	<div class="col-md-6">
	  <div class="form-group">
           <label for="materia_id" class="col-sm-2 control-label">Materia:</label>  
                 <div class="col-sm-10">
                       <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
                               <select class="form-control input-md" name="materia_id" id="txtPerfil" >
                                    <?php $materias = obtener_todos("materias"); 
